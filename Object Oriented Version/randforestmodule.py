...
class randforest():
    ...
    model = RandomForestClassifier(criterion='entropy', max_depth=10, min_samples_leaf=20, n_estimators=20)
    ...
    def confusion_matrix(self):
        ...
        plot_confusion_matrix(self.model,self.y_test, normalize='true',cmap='bwr')
        plt.show()
...
class randforest_rebalanced():
    
    model = RandomForestClassifier(criterion='entropy', max_depth=10, min_samples_leaf=20, n_estimators=20, class_weight='balanced')
...
if __name__ == "__main__":
    print("randforestmodule.py is being run directly")
    
else:
    print("randforestmodule.py is being imported into another module")
